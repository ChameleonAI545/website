    ...
    return (
        <div className="container-aboutUs ">
            <div className="centered-div-aboutUs rounded-2xl mx-auto px-6 py-12 comic-relief-regular leading-relaxed p-8 text-center">
                ...
                <p>Welcome to your ultimate AI discovery hub — where innovation meets simplicity.
                    ...
                    Our clean, minimal interface ensures a smooth, distraction-free experience so you can focus on discovering what’s possible. At our core, we’re driven by a simple mission: to make finding and using AI tools effortless, enjoyable, and accessible to everyone.</p>
